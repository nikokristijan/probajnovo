...
/**
 * Stakleni klon PushNotificationToggle.tsx — NAMJERNO odvojena komponenta
 * (vidi OwnerReservationForm za obrazloženje). Ista logika pretplate.
 */
export default function OwnerPushNotificationToggle({
  initialSubscribed,
}: {
  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      {subscribed ? (
        <button type="button" onClick={disable} disabled={busy || !checked} className="owner-btn-danger self-start">
        ...
        <button
          ...
          className="owner-btn-primary self-start"
        >
